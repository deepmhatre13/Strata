...
import { ArrowLeft, Mail, Lock, Eye, EyeOff, Moon } from 'lucide-react'
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSignin}>
              ...
              <div>
                ...
                <div className="flex justify-end">
                  <Link
                    to="/forgot-password"
                    className="text-xs hover:underline font-medium mt-1 cursor-pointer text-[#C17B5F] hover:text-[#B06A4E]"
                  >
                    Forgot password?
                  </Link>
                </div>
